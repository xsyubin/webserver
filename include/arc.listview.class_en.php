...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><span class=\"pageinfo\">Total <strong>1</strong> Pages<strong>".$this->TotalResult."</strong> Rows</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\">Total <strong>0</strong> Pages<strong>".$this->TotalResult."</strong> Rows</span></li>\r\n";
        }
        $purl = $this->GetCurUrl();
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<li><span class=\"pageinfo\">Total 1 Pages/".$this->TotalResult." Rows</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\">Total 0 Page/".$this->TotalResult." Rows</span></li>\r\n";
        }
        $maininfo = "<li><span class=\"pageinfo\">Total <strong>{$totalpage}</strong>pages<strong>".$this->TotalResult."</strong>Rows</span></li>\r\n";
